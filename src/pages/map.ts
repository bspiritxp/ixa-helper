...
import {complement, compose, filter, head, isEmpty, isNil, map} from 'ramda'
...
const getProfileURL = (): Array<string| undefined> => {
...
const findMainCastle = (page: HTMLDocument): string => {
    ...
    const findURL = (trElements: HTMLTableRowElement[]): string => {
